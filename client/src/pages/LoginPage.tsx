...
import { Eye, EyeOff, AlertCircle, Smartphone, Lock, Shield } from "lucide-react";
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--wr-bg)", padding: "24px 16px" }}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        {/* Form card */}
        <div style={{
          background: "var(--wr-sidebar-bg, #161b22)",
          ...
          <div style={{ marginBottom: 22 }}>
            <div style={{
              ...
              {step === "mfa"
                ? <Smartphone size={16} style={{ color: "#A78BFA" }} />
                : <Lock size={16} style={{ color: "#D4AF37" }} />}
              <h2 style={{ fontSize: 14, fontWeight: 600, color: "var(--wr-text-1)", margin: 0 }}>
                {step === "mfa" ? "Authentification MFA" : "Connexion sécurisée"}
              </h2>
            </div>
            ...
            <form onSubmit={handleCredentials} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div>
                ...
                <input
                  ...
                  className={inputCls}
                  placeholder="utilisateur@domaine.ma"
                />
              </div>
              ...
              <div style={{ textAlign: "center" }}>
                <a
                  href="/reset-password"
                  style={{ fontSize: 11, fontFamily: "monospace", color: "var(--wr-text-3)", textDecoration: "none" }}
            ...
            <form onSubmit={handleMfa} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div style={{ padding: "10px 14px", background: "rgba(139,92,246,0.08)", border: "1px solid rgba(139,92,246,0.2)", borderRadius: 8, textAlign: "center" }}>
                <p style={{ fontSize: 11, fontFamily: "monospace", color: "#A78BFA", margin: 0 }}>
                  Code à usage unique requis (TOTP 6 chiffres)
                </p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="000000"
                />
                <p style={{ fontSize: 10, fontFamily: "monospace", color: "rgba(180,196,216,0.35)", marginTop: 6, textAlign: "center" }}>
              ...
              <button
                ...
                style={{
                  width: "100%", padding: "10px 16px", borderRadius: 8, border: "none",
                  background: (loading || mfaCode.length < 6) ? "rgba(139,92,246,0.3)" : "#7C3AED",
              ...
              <button
                ...
                style={{ width: "100%", padding: "8px", background: "none", border: "none", cursor: "pointer", fontSize: 11, fontFamily: "monospace", color: "var(--wr-text-3)" }}
              >
