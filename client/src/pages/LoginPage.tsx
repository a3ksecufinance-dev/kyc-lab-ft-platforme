      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
        <div style={{ width: "100%", maxWidth: 360 }}>
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 12, color: "#3A5068", fontFamily: "monospace", margin: 0 }}>
              {step === "mfa" ? "Code à 6 chiffres requis" : "Accès restreint — personnel autorisé"}
            </p>
          </div>
          ...
          {step === "credentials" && (
            <form onSubmit={handleCredentials} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <button type="button" onClick={() => setShowPwd(!showPwd)} style={{
                    ...
                    background: "none", border: "none", cursor: "pointer", color: "#3A5068", padding: 0,
                  }}>
              ...
              <div style={{ textAlign: "center" }}>
                <a href="/reset-password" style={{ fontSize: 11, fontFamily: "monospace", color: "#2A4060", textDecoration: "none" }}
                  onMouseEnter={e => ((e.target as HTMLElement).style.color = "rgba(212,175,55,0.5)")}
                  onMouseLeave={e => ((e.target as HTMLElement).style.color = "#2A4060")}
                >
                  Mot de passe oublié ?
                </a>
              </div>
          ...
          {step === "mfa" && (
            <form onSubmit={handleMfa} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <button type="button" onClick={() => { setStep("credentials"); setError(null); setMfaCode(""); }} style={{
                ...
                fontSize: 11, fontFamily: "monospace", color: "#2A4060",
                padding: "4px 0",
              }}>
          ...
          <p style={{ textAlign: "center", fontSize: 10, fontFamily: "monospace", letterSpacing: "0.12em", textTransform: "uppercase", color: "#1A2A38", marginTop: 24 }}>
