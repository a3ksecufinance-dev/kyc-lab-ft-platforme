...
function CopyButton({ value, label }: { value: string; label?: string }) {
  const { t } = useI18n();
  const defaultLabel = label ?? t.mfa.copyCode;
        ...
        {step === "status" && (
          <>
            ...
            {!mfaEnabled && (
              ...
              >
                {setupMutation.isPending ? t.common.loading : t.mfa.setup}
              </button>
            )}
              ...
              <div className="space-y-2">
                ...
                >
                  <span className="flex items-center justify-center gap-2">
                    <ShieldOff size={12} /> {t.mfa.disable}
                  </span>
                </button>
                <button
          ...
          <div className="bg-[#0d1117] border border-[#21262d] rounded-lg overflow-hidden">
            ...
            <div className="p-5 space-y-5">
              ...
              <div className="flex gap-2">
                ...
                >
                  {confirmMutation.isPending || regenMutation.isPending ? t.common.loading : t.mfa.verify}
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0d1117] border border-red-400/20 rounded-lg overflow-hidden">
            ...
            <div className="p-5 space-y-3">
              ...
              <div className="flex gap-2">
                ...
                >
                  {disableMutation.isPending ? t.mfa.disabling : t.mfa.disable}
                </button>
              </div>
            </div>
          </div>
